...
import InfxInfxbcInfxInfxbcInfxbc from './infx/infxbc/infx.infxbc.infxbc';
import CosmosCosmosSdkCosmosBaseV1Beta1 from './cosmos/cosmos-sdk/cosmos.base.v1beta1';
import InfxInfxbcInfxInfxbcReward from './infx/infxbc/infx.infxbc.reward';
...
export default {
    ...
    InfxInfxbcInfxInfxbcInfxbc: load(InfxInfxbcInfxInfxbcInfxbc, 'infx.infxbc.infxbc'),
    CosmosCosmosSdkCosmosBaseV1Beta1: load(CosmosCosmosSdkCosmosBaseV1Beta1, 'cosmos.base.v1beta1'),
    InfxInfxbcInfxInfxbcReward: load(InfxInfxbcInfxInfxbcReward, 'infx.infxbc.reward'),
