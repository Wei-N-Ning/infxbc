...
const baseRewardV01: object = { creator: '', id: 0, userId: '', amount: '' }

export const RewardV01 = {
  encode(message: RewardV01, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): RewardV01 {
    ...
    const message = { ...baseRewardV01 } as RewardV01
