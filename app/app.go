...
import (
	...
	appparams "github.com/infx/infxbc/app/params"
	"github.com/infx/infxbc/docs"
...
func New(
	...
	app.InfxbcKeeper = *infxbckeeper.NewKeeper(
		...
		keys[infxbctypes.MemStoreKey],
	)
	infxbcModule := infxbc.NewAppModule(appCodec, app.InfxbcKeeper)
