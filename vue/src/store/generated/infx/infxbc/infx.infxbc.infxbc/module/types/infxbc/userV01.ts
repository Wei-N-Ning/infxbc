...
const baseUserV01: object = { creator: '', id: 0, name: '', role: '' }

export const UserV01 = {
  encode(message: UserV01, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): UserV01 {
    ...
    const message = { ...baseUserV01 } as UserV01
